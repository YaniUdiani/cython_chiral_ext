module chiral_potentials 
  ...
  REAL*8 :: CE=-.389, CD=-0.39, Econst, Dconst, lec_c1, lec_c2, lec_c3, lec_c4   
...
!    write(6,*) L,fourmpi2(impi),const(4)
  ...
  complex*16 function chiral_pot(nx1, ny1, nz1, nx2, ny2, nz2, nx3, ny3, nz3, nx4, &
	ny4,nz4,m1,m2,m3,m4,t1,t2,t3,t4,L,twistx,twisty,twistz)
    
    implicit none 
    INTEGER, INTENT(IN) :: nx1, ny1, nz1, nx2, ny2, nz2, nx3, ny3, nz3, nx4, ny4,&
    ...
    IF (chp_chiral_order%val >= NLO) THEN
       ...
       !if (abs(chp_spin_dot_qxk_mtx(m1,m2,m3,m4,qxk) - chp_spin_dot_qxk(m1,m2,m3,m4,qxk))>1.e-10 ) THEN 
       !   write(6,*) chp_spin_dot_qxk_mtx(m1,m2,m3,m4,qxk), chp_spin_dot_qxk(m1,m2,m3,m4,qxk)
       !end if
  ...
  complex*16 function chiral_3nf(nx1, ny1, nz1, nx2, ny2, nz2, nx3, ny3, nz3, &
    nx4, ny4, nz4, nx5, ny5, nz5 , nx6, ny6, nz6,m1,m2,m3,m4,m5,m6,t1,t2,t3,t4,t5,t6,L,twistx,twisty,twistz)
  ...
  real*8 function vmom_minnesota(nx1, ny1, nz1, nx2, ny2, nz2, nx3, ny3, nz3, nx4, &
	ny4,nz4,m1,m2,m3,m4,t1,t2,t3,t4,L,twistx,twisty,twistz)
